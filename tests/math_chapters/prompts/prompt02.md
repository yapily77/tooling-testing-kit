...
* **Reference File:** `tests/math_chapters/test_ch02_hidden_reserves.py` (Append tests here or create `tests/math_chapters/test_ch02_edge_cases.py`)
* **Source Modules:** `src/engine/module2_root.py`, `src/engine/module0_geju.py`, `src/core/schemas/unified.py`
...
**Reference Functions:** `_has_meaningful_root` in `src/engine/module0_geju.py` and `ZHI_HIDDEN` in `src/core/schemas/unified.py`
**Task Details:**
...
**Target File:** `TEST/math/test_ch02_edge_cases.py`
**Reference Function:** `get_root_sub_score` / root logic in `src/engine/module2_root.py`
**Task Details:**
...
**Target File:** `TEST/math/test_ch02_edge_cases.py`
**Reference Function:** `selective_hidden_extraction` in `src/engine/module2_root.py`
**Task Details:**
