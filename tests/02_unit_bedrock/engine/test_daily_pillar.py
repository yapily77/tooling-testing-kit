...
from src.tools.bazi_engine import get_day_master_strength, get_pillars, score_elements
...
class TestGetPillars:
    ...
    def test_solar_term_boundary_month(self):
        ...
        assert before["month"] != after["month"], "Month pillar should change across 立春"
...
class TestDayMasterStrength:
    ...
    def test_shen_qiang_correct_logic(self):
        ...
        r = get_day_master_strength(p)
        if r["strength"] == "身强":
            from src.tools.bazi_engine import SUPPORTS
...
class TestResolveDailyPillarRange:
    def test_cross_year_range(self):
        ...
        from src.engine.daily_pillar import resolve_daily_pillar_range
    ...
    def test_cross_year_pillar_continuity(self):
        ...
        assert dates == ["2025-12-30", "2025-12-31", "2026-01-01", "2026-01-02", "2026-01-03", "2026-01-04", "2026-01-05"]
...
class TestGetMonthAnchor:
    def test_jan_date_uses_prev_year_anchor(self):
        ...
        from src.engine.daily_pillar import get_month_anchor_for_date, resolve_daily_pillar
