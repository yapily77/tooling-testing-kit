...
def profile_male_weak():
    ...
    return ChartProfile(
        gender="M",
        dob="2000-01-01",
        day_pillar=Pillar(stem="Yi", branch="Mao"),
        ...
        ge_ju_type="yin_xiao_ge",  # Resource pattern
    )
...
def profile_male_strong():
    ...
    return ChartProfile(
        gender="M",
        dob="2000-01-01",
        day_pillar=Pillar(stem="Wu", branch="Xu"),
        month_pillar=Pillar(stem="Ji", branch="Wei"),
        year_pillar=Pillar(stem="Geng", branch="Shen"),
        hour_pillar=Pillar(stem="Xin", branch="You"),
        dm_strength_type="Strong",
        ge_ju_type="shi_shen_ge",  # Eating God pattern
    )
...
def profile_female_weak():
    ...
    return ChartProfile(
        gender="F",
        dob="2000-01-01",
        day_pillar=Pillar(stem="Ding", branch="You"),
        month_pillar=Pillar(stem="Ren", branch="Chen"),
        year_pillar=Pillar(stem="Gui", branch="Hai"),
        hour_pillar=Pillar(stem="Jia", branch="Yin"),
        dm_strength_type="Weak",
        ge_ju_type="cai_ge",  # Wealth pattern
    )
...
def compatible_profile():
    ...
    return ChartProfile(
        ...
        month_pillar=Pillar(stem="Ding", branch="Mao"),
        year_pillar=Pillar(stem="Wu", branch="Chen"),
        hour_pillar=Pillar(stem="Ji", branch="Wei"),
        dm_strength_type="Balanced",
        ge_ju_type="zheng_guan_ge",  # Officer pattern
    )
...
def incompatible_profile():
    ...
    return ChartProfile(
        gender="F",
        dob="2000-01-01",
        day_pillar=Pillar(stem="Geng", branch="Xu"),
        month_pillar=Pillar(stem="Xin", branch="Hai"),
        year_pillar=Pillar(stem="Ren", branch="Zi"),
        hour_pillar=Pillar(stem="Gui", branch="Chou"),
        dm_strength_type="Strong",
        ge_ju_type="qi_sha_ge",  # 7K pattern
    )
...
class TestOverallCompatibility:
    ...
    def test_compatibility_score_range(self, profile_male_weak, compatible_profile):
        ...
        result = analyze_compatibility(profile_male_weak, compatible_profile)
    ...
    def test_compatibility_has_required_fields(self, profile_male_weak, compatible_profile):
        ...
        assert result.breakdown.ge_ju is not None
        assert result.breakdown.day_master is not None
        assert result.breakdown.branch_chemistry is not None
        assert result.breakdown.peach_blossom is not None

    def test_exceptional_compatibility(self):
        """Test exceptionally compatible profiles."""
        profile1 = ChartProfile(
            gender="M",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Jia", branch="Yin"),
            month_pillar=Pillar(stem="Bing", branch="Chen"),
            year_pillar=Pillar(stem="Wu", branch="Wu"),
            hour_pillar=Pillar(stem="Geng", branch="Shen"),
            dm_strength_type="Strong",
            ge_ju_type="zheng_guan_ge",
        )

        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Ji", branch="You"),
            month_pillar=Pillar(stem="Ding", branch="Si"),
            year_pillar=Pillar(stem="Gui", branch="Hai"),
            hour_pillar=Pillar(stem="Yi", branch="Mao"),
            dm_strength_type="Weak",
            ge_ju_type="yin_xiao_ge",
        )

        result = analyze_compatibility(profile1, profile2, category="partner")
    ...
    def test_discordant_compatibility(self):
        ...
        profile1 = ChartProfile(
            ...
            year_pillar=Pillar(stem="Bing", branch="Yin"),
            hour_pillar=Pillar(stem="Ding", branch="Mao"),
            dm_strength_type="Strong",
            ge_ju_type="qi_sha_ge",
        )

        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Geng", branch="Wu"),  # Clashes with Zi
            month_pillar=Pillar(stem="Xin", branch="Wei"),  # Clashes with Chou
            year_pillar=Pillar(stem="Ren", branch="Shen"),
            hour_pillar=Pillar(stem="Gui", branch="You"),
            dm_strength_type="Strong",
            ge_ju_type="qi_sha_ge",
        )
    ...
    def test_neutral_compatibility(self):
        ...
        profile1 = ChartProfile(
            ...
            hour_pillar=Pillar(stem="Geng", branch="Shen"),
            dm_strength_type="Balanced",
            ge_ju_type="common_pattern",
        )

        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Geng", branch="Shen"),
        ...
        result = analyze_compatibility(profile1, profile2)
...
class TestGeJuCompatibility:
    ...
    def test_resource_officer_compatibility(self, profile_male_weak):
        ...
        officer_profile = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Bing", branch="Yin"),
            month_pillar=Pillar(stem="Wu", branch="Wu"),
            year_pillar=Pillar(stem="Geng", branch="Shen"),
            hour_pillar=Pillar(stem="Xin", branch="You"),
            dm_strength_type="Strong",
            ge_ju_type="zheng_guan_ge",
    ...
    def test_wealth_resource_conflict(self):
        ...
        result = analyze_compatibility(wealth_profile, resource_profile)

        assert result.breakdown.ge_ju.score < 70

    def test_7k_eating_god_compatibility(self):
        """Test 7 Killings + Eating God compatibility."""
        seven_k_profile = ChartProfile(
            gender="M",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Geng", branch="Xu"),
            month_pillar=Pillar(stem="Xin", branch="Hai"),
        ...
        eating_god_profile = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Bing", branch="Shen"),
            month_pillar=Pillar(stem="Ding", branch="You"),
            year_pillar=Pillar(stem="Wu", branch="Xu"),
            hour_pillar=Pillar(stem="Ji", branch="Hai"),
            dm_strength_type="Weak",
            ge_ju_type="shi_shen_ge",
        )

        result = analyze_compatibility(seven_k_profile, eating_god_profile)
...
class TestDayMasterInteraction:
    ...
    def test_production_cycle_day_master(self):
        ...
        profile1 = ChartProfile(
            gender="M",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Jia", branch="Yin"),  # Wood
            month_pillar=Pillar(stem="Bing", branch="Chen"),
            year_pillar=Pillar(stem="Wu", branch="Wu"),
            hour_pillar=Pillar(stem="Geng", branch="Shen"),
            dm_strength_type="Strong",
        ...
        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Bing", branch="Chen"),  # Fire (produced by Wood)
            month_pillar=Pillar(stem="Wu", branch="Wu"),
            year_pillar=Pillar(stem="Geng", branch="Shen"),
            hour_pillar=Pillar(stem="Xin", branch="You"),
            dm_strength_type="Weak",
    ...
    def test_control_cycle_day_master(self):
        ...
        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Geng", branch="Shen"),  # Metal (controls Wood)
...
class TestBranchChemistry:
    ...
    def test_liu_he_combination(self):
        ...
        profile1 = ChartProfile(
            gender="M",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Jia", branch="Zi"),  # Zi branch
            month_pillar=Pillar(stem="Bing", branch="Yin"),
            year_pillar=Pillar(stem="Wu", branch="Chen"),
            hour_pillar=Pillar(stem="Geng", branch="Shen"),
            dm_strength_type="Strong",
        ...
        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Yi", branch="Chou"),  # Chou branch (Liu He with Zi)
            month_pillar=Pillar(stem="Ding", branch="Mao"),
            year_pillar=Pillar(stem="Ji", branch="Wei"),
            hour_pillar=Pillar(stem="Gui", branch="You"),
            dm_strength_type="Weak",
    ...
    def test_san_he_combination(self):
        ...
        profile1 = ChartProfile(
            gender="M",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Jia", branch="Yin"),  # Yin branch (Wood)
            month_pillar=Pillar(stem="Bing", branch="Chen"),
            year_pillar=Pillar(stem="Wu", branch="Wu"),
            hour_pillar=Pillar(stem="Geng", branch="Shen"),
            dm_strength_type="Strong",
        ...
        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Yi", branch="Mao"),  # Mao branch (Wood)
            month_pillar=Pillar(stem="Ding", branch="Si"),
            year_pillar=Pillar(stem="Ji", branch="Wei"),
            hour_pillar=Pillar(stem="Gui", branch="You"),
            dm_strength_type="Weak",
    ...
    def test_chong_clash(self):
        ...
        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Geng", branch="Wu"),  # Wu branch (clashes with Zi)
            month_pillar=Pillar(stem="Xin", branch="Wei"),
            year_pillar=Pillar(stem="Ren", branch="Shen"),
            hour_pillar=Pillar(stem="Gui", branch="You"),
            dm_strength_type="Weak",
            ge_ju_type="common_pattern",
    ...
    def test_xing_punishment(self):
        ...
        profile1 = ChartProfile(
            gender="M",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Jia", branch="Yin"),  # Yin branch
            month_pillar=Pillar(stem="Bing", branch="Chen"),
            year_pillar=Pillar(stem="Wu", branch="Wu"),
            hour_pillar=Pillar(stem="Geng", branch="Shen"),
            dm_strength_type="Strong",
        ...
        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Yi", branch="Si"),  # Si branch (punishes Yin)
            month_pillar=Pillar(stem="Bing", branch="Wu"),
            year_pillar=Pillar(stem="Ji", branch="Wei"),
            hour_pillar=Pillar(stem="Gui", branch="You"),
            dm_strength_type="Weak",
            ge_ju_type="common_pattern",
...
class TestPeachBlossom:
    ...
    def test_mutual_peach_blossom(self):
        ...
        profile1 = ChartProfile(
            gender="M",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Jia", branch="Zi"),  # Day branch Zi
            month_pillar=Pillar(stem="Bing", branch="Yin"),
            year_pillar=Pillar(stem="Wu", branch="Chen"),
            hour_pillar=Pillar(stem="Geng", branch="Shen"),
            dm_strength_type="Strong",
        ...
        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Yi", branch="Mao"),  # Day branch Mao (PB for Zi)
            month_pillar=Pillar(stem="Ding", branch="Si"),
            year_pillar=Pillar(stem="Ji", branch="Wei"),
            hour_pillar=Pillar(stem="Gui", branch="You"),
            dm_strength_type="Weak",
    ...
    def test_one_sided_peach_blossom(self):
        ...
        profile2 = ChartProfile(
            gender="F",
            dob="2000-01-01",
            day_pillar=Pillar(stem="Jia", branch="Chen"),  # Day branch Chen (not PB for Zi)
            month_pillar=Pillar(stem="Ding", branch="Mao"),  # But Mao is PB for Zi
            year_pillar=Pillar(stem="Ji", branch="Wei"),
            hour_pillar=Pillar(stem="Gui", branch="You"),
            dm_strength_type="Weak",
            ge_ju_type="common_pattern",
...
class TestEdgeCases:
    ...
    def test_same_person_compatibility(self, profile_male_weak):
        ...
        result = analyze_compatibility(profile_male_weak, profile_male_weak)
