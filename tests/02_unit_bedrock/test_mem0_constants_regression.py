"""Regression tests for src.core.memory constants and the mem0_store import.
...
def test_qdrant_memory_collection_constant_importable():
    ...
    from src.core.memory.constants import QDRANT_MEMORY_COLLECTION
...
def test_mem0_store_module_imports_without_error():
    ...
    mod = importlib.import_module("src.core.memory.mem0_store")
...
def test_qdrant_rag_collection_correctly_removed():
    ...
    import src.core.memory.constants as consts
...
def test_turbovec_sqlite_paths_remain_intact():
    ...
    from src.core.memory.constants import (
        BAZI_SQLITE_PATH,
        TURBOVEC_INDEX_PATH,
        VECTOR_SIZE,
    )
