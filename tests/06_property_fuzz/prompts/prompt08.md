...
**Target File:** `src/core/memory/mem0_store.py`
**Violation Count:** 2
**Task Details:**
...
**Target File:** `src/interfaces/telegram/report_utils.py`
**Violation Count:** 1
**Task Details:**
...
**Target File:** `src/interfaces/telegram/evaluation.py`
**Violation Count:** 1
**Task Details:**
...
**Target File:** `src/interfaces/telegram/chronomancer/oracle_narrator.py`
**Violation Count:** 1
**Task Details:**
...
**Target File:** `src/interfaces/telegram/chronomancer/oracle_gatherer.py`
**Violation Count:** 1
**Task Details:**
...
**Target File:** `src/engine/rag_client.py`
**Violation Count:** 1
**Task Details:**
...
**Target File:** `src/engine/module9_triggers.py`
**Violation Count:** 1
**Task Details:**
* 1 missing type annotation in Module 9 (Triggers) engine.
* Function likely returns trigger analysis results.
* **Strategy:** Check `src/core/schemas/` for trigger types. Likely `dict[str, Any]` or custom model.
